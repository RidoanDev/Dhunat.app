...
const Notifications = () => {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'new-service': return <Star size={14} className="text-green-600" />;
      case 'app-update': return <Info size={14} className="text-blue-600" />;
      case 'update': return <AlertCircle size={14} className="text-orange-600" />;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-4 pb-20">
        <div className="flex items-center mb-4">
          ...
          <h1 className="text-lg font-semibold text-gray-900">বিজ্ঞপ্তি</h1>
        </div>
